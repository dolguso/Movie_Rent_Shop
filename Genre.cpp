...
inline Genre::Genre(std::string genre_name, double default_fee, double additional_fee, int default_point, int additional_point, int default_day_for_point) :
	genre_name(genre_name), default_fee(default_fee), additional_fee(additional_fee), default_point(default_point), additional_point(additional_point), default_day_for_point(default_day_for_point) {};
